...
export const PackageList = () => {
  ...
  const getEmailsOfBookedUsers = async (packageId: string | number) => {
    ...
    const emailList = bookingsRes.data.map((booking: any) => ({
      id: booking.userId,
      ...
      >
        <Datagrid rowClick={false} bulkActionButtons={false}>
          ...
          <FunctionField<PackageRecord>
            render={(record: { rating: number | null | undefined }) =>
          ...
          <FunctionField
            label="Admin"
            render={(record: { isApproved: string }) => {
                ...
                <div>
                  <IconButton
                    onClick={async () => {
                      ...
                      navigate("/vendor/EmailToUserFromList", {
                        state: { customers: emails },
                      });
                    }}
                  >
                    <MailIcon />
